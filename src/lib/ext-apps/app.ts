...
export class App extends Protocol<Request, Notification, Result> {
     ...
     * @internal
     */
    assertCapabilityForMethod(_method: Request["method"]): void {
        // TODO
    }
    ...
    assertRequestHandlerCapability(method: Request["method"]): void {
        switch (method) {
            ...
            case "ping":
                return;
            default:
                // Allow custom app.* and host.* methods for extension
                if (method.startsWith("app.") || method.startsWith("host.")) {
                    return;
                }
     ...
     * @internal
     */
    assertNotificationCapability(_method: Notification["method"]): void {
        // TODO
    }

    /**
     * Verify that the app supports the capability required for task operations.
     * @internal
     */
    assertTaskCapability(): void {
        // TODO: Implement task capability checking when tasks are supported
    }

    /**
     * Verify that the app declared the capability required for task handler operations.
     * @internal
     */
    assertTaskHandlerCapability(): void {
        // TODO: Implement task handler capability checking when tasks are supported
    }

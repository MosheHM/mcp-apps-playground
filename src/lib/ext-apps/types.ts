 ...
 *
 * The Guest UI MUST send this notification after receiving the
 * {@link McpUiInitializeResult} response. This signals to the host that the app
 * is ready to receive tool input and other data.
 *
 * @see {@link McpUiInitializeRequest} for the start of the handshake
 */

...
export class AppBridge extends Protocol<Request, Notification, Result> {
   ...
   * @internal
   */
  assertRequestHandlerCapability(_method: Request["method"]): void {
    // TODO
  }
  ...
  /**
   * Verify that the host supports the capability required for task operations.
   * @internal
   */
  ...
  /**
   * Verify that the host declared the capability required for task handler operations.
   * @internal
   */
